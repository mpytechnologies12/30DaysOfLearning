...
Python LIBRARIES - FAST API, REQUESTS, Context Manager
Python / C# Language
...
4) Develop a automation data-driven framework for testing https://hrm.mnjsoftware.com web portal in next 30 days at max.
...
16) Moving forward, I would request you to create a whatsapp group - MNJ INTERN PYTHON_DDMMYY_6_3 OR MNJ INTERN PYTHON_DDMMYY_3_12 ( DDMMYY - DATE OF JOINING ), add +91-9654136060 (Admin), +91-7982733174 (Admin), +91-9868460154 (Admin) and moving forward send all the messages in the group only.
